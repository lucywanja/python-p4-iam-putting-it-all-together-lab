"""Recipe and User migration

Revision ID: 5817886ab5ca
Revises: 
Create Date: 2024-09-06 19:48:31.668756
...
def upgrade():
    ...
    sa.Column('_password_harsh', sa.String(), nullable=True),
